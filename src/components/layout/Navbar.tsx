    ...
    <header className="w-full sticky top-0 z-50 bg-white border-b shadow-sm">
      ...
      <div className="max-w-7xl mx-auto px-4 h-20 flex items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-10">
          ...
          {navLink('/shop/peptides', 'Peptides', pathname === '/shop/peptides')}
            ...
            <SheetContent side="left" className="w-72 overflow-y-auto">
              <nav className="mt-6 space-y-0.5">
                ...
                <div className="pt-2 mt-2 border-t space-y-0.5">
                  <Link href="/shop/peptides" onClick={() => setMobileOpen(false)} className="block px-3 py-2 text-sm font-medium rounded-md text-gray-700 hover:bg-gray-100 hover:text-[#ec6a82]">Peptides</Link>
